...
exports.FORBIDDEN_JARGON_PATTERNS = exports.LEGACY_STORAGE_KEY_VIEW_MODE = exports.STORAGE_KEY_VIEW_MODE = void 0;
exports.containsJargon = containsJargon;
exports.getHealthLabel = getHealthLabel;
exports.getPlainSummary = getPlainSummary;
exports.getBasicRiskNote = getBasicRiskNote;
exports.getOneLineDescription = getOneLineDescription;
exports.getResearchViewMode = getResearchViewMode;
exports.setResearchViewMode = setResearchViewMode;
exports.STORAGE_KEY_VIEW_MODE = 'alphainsight_research_view_mode';
exports.LEGACY_STORAGE_KEY_VIEW_MODE = 'finintel_research_view_mode';
exports.FORBIDDEN_JARGON_PATTERNS = [
    /\bP\/E\b/i,
    /\bROE\b/i,
    /\bROA\b/i,
    /\bRSI\b/i,
...
function containsJargon(text) {
    if (!text)
        return false;
    return exports.FORBIDDEN_JARGON_PATTERNS.some((regex) => regex.test(text));
}
/**
 ...
 */
function getPlainSummary(report, healthLabel) {
 ...
 */
function getBasicRiskNote(report) {
 ...
 */
function getOneLineDescription(report) {
 ...
 */
function getResearchViewMode() {
    if (typeof window === 'undefined')
        return 'simple';
    try {
        const saved = localStorage.getItem(exports.STORAGE_KEY_VIEW_MODE) || localStorage.getItem(exports.LEGACY_STORAGE_KEY_VIEW_MODE);
        if (saved === 'advanced')
            return 'advanced';
        return 'simple';
    }
...
function setResearchViewMode(mode) {
    if (typeof window === 'undefined')
        return;
    try {
        localStorage.setItem(exports.STORAGE_KEY_VIEW_MODE, mode);
    }
    catch (err) {
